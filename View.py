...
class View(Tk):
    ...
    def __init__(self):
        ...
        self.__canvas = FigureCanvasTkAgg(self.__figure, self.__graph_frm, self.__figure)
        # Рамка для розміщення віджетів
        self.__widgets_frm = LabelFrame(self, text="Введення сипску ребер", font=("Comic Sans MS", 16))
